...
369 entries from 131 R packages survive the
funnel with corpus exposure. Of those, **207** have been read and judged.
...
Entries are queued in descending corpus exposure, so the 207 judged
are the most-exposed ones. What is left unread is the tail:

* judged: **207** of 369 (56%)
* unjudged: **162**, none exposed to more than **25** corpus scripts
...
The regular-expression layer agreed with the reading on **110**
of 207 entries and disagreed on **97** (47%).
...
|---|---|---|
| RESULT_CHANGING | RESULT_CHANGING | 110 |
| RESULT_CHANGING | ERROR_TO_WORKING ** | 31 |
| RESULT_CHANGING | DOC ** | 30 |
| RESULT_CHANGING | UNCLEAR ** | 28 |
...
Silent (quietly wrong, no error or warning): **109**; loud: 98.

**110** entries could have moved a number in a published table -- silent result-changing bugs, plus behaviour
...
**79** of 131 packages yielded no exposed candidate at all.
